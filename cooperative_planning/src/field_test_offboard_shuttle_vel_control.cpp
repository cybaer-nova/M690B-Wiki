...
double kp_velocity = 1.5, ki_velocity = 0, kd_velocity = 0, kp_heading = 0;
...
int main (int argc, char ** argv){
    ...
    while(ros::ok() && !finished_trajectory){
        ...
        ROS_WARN_STREAM("Target Velocity " << desiredVelocityLinear.x  << "  " << desiredVelocityLinear.y  << "  " << desiredVelocityLinear.z);
